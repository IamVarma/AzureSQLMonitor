...
namespace AzureSQLApp.AzureSQLService1 {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISqlMonitorServiceChannel : AzureSQLApp.AzureSQLService1.ISqlMonitorService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SqlMonitorServiceClient : System.ServiceModel.ClientBase<AzureSQLApp.AzureSQLService1.ISqlMonitorService>, AzureSQLApp.AzureSQLService1.ISqlMonitorService {
        ...
        private static System.ServiceModel.Channels.Binding GetBindingForEndpoint(EndpointConfiguration endpointConfiguration) {
            ...
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpsBinding_ISqlMonitorService)) {
                System.ServiceModel.BasicHttpBinding result = new System.ServiceModel.BasicHttpBinding();
                result.MaxBufferSize = int.MaxValue;
                result.ReaderQuotas = System.Xml.XmlDictionaryReaderQuotas.Max;
                result.MaxReceivedMessageSize = int.MaxValue;
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration) {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ISqlMonitorService)) {
                return new System.ServiceModel.EndpointAddress("http://www.azuresqlmonitor.in/SqlMonitorService.svc");
            }
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpsBinding_ISqlMonitorService)) {
                return new System.ServiceModel.EndpointAddress("https://rd00155d393858/SqlMonitorService.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
        ...
        public enum EndpointConfiguration {
            ...
            BasicHttpsBinding_ISqlMonitorService,
        }
    }
}
